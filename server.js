/**
 * 专升本英语学习系统 - 后端服务器
 * 支持 Render / Vercel / 本地部署
 * 功能：用户注册/登录、学习进度同步、错题本同步、PWA 支持
 */
...
const JWT_SECRET = process.env.JWT_SECRET || 'english_learning_system_secret_key_2024';
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('');
  console.log('  PWA 模式：支持添加到桌面，离线可用');
  console.log('  安卓/iOS/鸿蒙 三端通用');
  console.log('');
